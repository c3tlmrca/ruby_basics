class Train
  attr_reader :type, :carriages_quantity, :route, :speed
  ...
  def remove_car
    return unless @speed.zero? && @carriages_quantity.positive?
  ...
  def validate!
    raise ArgumentError, 'Кол-во вагонов не должно быть < 0' if @carriages_quantity.negative?
  end
end
